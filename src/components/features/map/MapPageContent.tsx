        ...
        <main className="min-h-screen bg-[radial-gradient(circle_at_14%_16%,color-mix(in_oklch,var(--accent)_26%,transparent),transparent_25%),linear-gradient(180deg,var(--flora-hero-start)_0%,var(--background)_88%)] px-3 pb-24 pt-22 text-foreground sm:px-5 sm:pb-10 sm:pt-24 lg:px-6 xl:px-8">
            ...
            {selectedPlant && (
                <div className="fixed inset-0 z-[72] lg:hidden">
                    <button
                        type="button"
                        aria-label="Close selected plant"
...
function SelectedPlantPanel({
    ...
    return (
        <div className="flora-glass overflow-hidden rounded-2xl border border-primary/20 bg-background/82 p-4 shadow-lg shadow-foreground/6">
            <div className="flex items-start justify-between gap-4">
                ...
                <button
                    type="button"
                    onClick={onClose}
                    className="grid size-9 shrink-0 place-items-center rounded-full border border-border bg-card/72 text-muted-foreground transition-colors hover:bg-secondary"
                >
                    <X className="h-4 w-4" />
                </button>
            </div>
            ...
            <div className="mt-4 flex items-start gap-4">
                <PlantThumb plant={plant} active large />
                <div className="min-w-0 flex-1">
